...
import 'package:egy_tour/features/layout/presentation/views/widgets/lists_of_items/list_of_tours.dart';

class TourSearch extends StatelessWidget {
  final List<TourModel> tours;
  const TourSearch({super.key, required this.tours});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AppCubit, AppState>(
      builder: (context, state) {
        return Scaffold(
          appBar: AppBar(
            title: Text('Tours', style: Styles.textStyle600),
            centerTitle: true,
            leading: IconButton(
              onPressed: () {
                  ...
                  ? cubit.searchData.isEmpty
                      ...
                      : Expanded(
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: 16),
                          child: ListOfTours(
                        tours: cubit.searchData as List<TourModel>,
                      ),
                        ),
