...
class ListOfHotelItemsReviews extends StatelessWidget {

  final List<HiveHotelModel> model;
  const ListOfHotelItemsReviews({
    super.key,
    required this.model,
  });
            ...
            return GestureDetector(
              onTap: () {
                NavigatorMethods.push(
                  context: context,
                  nextPage: HotelBooking(model: model[index].model),
                );
              },
              child: ReviewItem(
